...
//               All rights reserved
// ----------------------------------------------
//             SilverRainWipeUpNode
// ----------------------------------------------

import {SilverRainTransitionNode} from './../SilverRainTransitionNode.js';

class SilverRainWipeUpNode extends SilverRainTransitionNode {
    ...
    __createFragmentShaderSource() {
        this.__fSrc = `
			...
			void main() {
				...
				gl_FragColor = mix(color1, color2, step(v_texCoord.y, u_mix));
			}
        `;
	}
    static __draw = {
