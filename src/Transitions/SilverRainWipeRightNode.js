...
//               All rights reserved
// ----------------------------------------------
//            SilverRainWipeRightNode
// ----------------------------------------------

import {SilverRainTransitionNode} from './../SilverRainTransitionNode.js';

class SilverRainWipeRightNode extends SilverRainTransitionNode {
    ...
    __createFragmentShaderSource() {
        this.__fSrc = `
			...
			void main() {
				...
				gl_FragColor = mix(color1, color2, step(v_texCoord.x, u_mix));
			}
        `;
	}
    static __draw = {
...
export {SilverRainWipeRightNode};
