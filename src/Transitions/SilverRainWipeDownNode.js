...
//               All rights reserved
// ----------------------------------------------
//            SilverRainWipeDownNode
// ----------------------------------------------

import {SilverRainTransitionNode} from './../SilverRainTransitionNode.js';

class SilverRainWipeDownNode extends SilverRainTransitionNode {
    ...
    __createFragmentShaderSource() {
        this.__fSrc = `
			...
			void main() {
				...
				gl_FragColor = mix(color1, color2, step(1.0 - v_texCoord.y, u_mix));
			}
        `;
	}
    static __draw = {
